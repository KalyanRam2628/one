...
<body>
	...
	<h1 style="color: blue; font-size: 40px;" align="center">hello kalyan ram , how are you,i hopw ypu are doing good</h1>
	<h1 style="color: red; font-size: 40px;" align="center">thala fro reason kalyan ram how are yuu</h1>
